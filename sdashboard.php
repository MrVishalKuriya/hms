...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-6">
                <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Dashboard<i
                        class="fa fa-hand-o-left"></i></h1>
            </div>
            <div class="col-lg-6">
                <form action="sdashboard.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                    <button class="btn btn-success pull-right margin-to-5" type="submit" name="btnAttend"><i
                            class="fa fa-2x fa-check"></i>Attendence</button>
                </form>
            </div>
        </div>
        <!-- /.col-lg-12 -->
...
$(function() {
    ...
    function showEvents($contentEl, dateProperties) {
        ...
        var $events = $('<div id="custom-content-reveal" class="custom-content-reveal"><h4>Events for ' +
                dateProperties.monthname + ' ' + dateProperties.day + ', ' + dateProperties.year + '</h4></div>'
            ),
