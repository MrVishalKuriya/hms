        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span style="display:none;" class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button>
                <img alt="HMS" class="pull-left" src="<?php echo $base_url.''?>"><a class="navbar-brand titlehms"
                    href="<?php echo $base_url.'edashboard.php'?>">Hostel Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo $base_url;?>ui/usr/profilee.php"><i class="fa fa-user fa-fw"></i>User
                                Profile</a>
                        </li>
