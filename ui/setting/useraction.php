        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="fees" action="useraction.php?update=1" onsubmit="return checkForm(this);"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Login Id" class="form-control"
                                                        name="loginId" value="<?php echo $loginId;?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="password" placeholder=""
                                                        class="form-control" name="password" value="<?php echo $pass;?>"
                                                        required>
                                                </div>
                                            </div>
