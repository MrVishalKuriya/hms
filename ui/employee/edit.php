        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="payment" action="edit.php?update=1" onsubmit="return checkForm(this);"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Mobile No" class="form-control"
                                                        name="cellNo" value="<?php echo $data[1];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Employee Type" class="form-control"
                                                        name="empType" value="<?php echo $data[2];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Designation" class="form-control"
                                                        name="designation" value="<?php echo $data[3];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group date" id='dp1'>
                                                    ...
                                                    <input type="text" placeholder="Date Of Birth"
                                                        ...
                                                        value="<?php echo $data[5];?>" required
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group date" id='dp1'>
                                                    ...
                                                    <input type="text" placeholder="Join Date"
                                                        class="form-control datepicker" name="doj"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Block No" class="form-control"
                                                        name="blockNo" value="<?php echo $data[7];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-info"></i> </span>
                                                    <input type="text" placeholder="Salary" class="form-control"
                                                        name="salary" value="<?php echo $data[8];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea rows="3" placeholder="Address" class="form-control"
                                                        name="presentAddress"
                                                        required> <?php echo $data[9];?></textarea>
                                                </div>
                                            </div>
                                        </div>
