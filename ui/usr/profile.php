...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Profile<i class="fa fa-hand-o-left"></i>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-4">
                        <img src="./../../files/photos/<?php echo $data[21]?>" alt="Avatar" height="220px"
                            class="img-responsive img-rounded proimg">
                    </div>
                    <div class="col-lg-4">
                    </div>
                </div>
