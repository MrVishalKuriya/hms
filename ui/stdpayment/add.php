        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="attendence" action="add.php" accept-charset="utf-8" method="post"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group date" id='dp1'>
                                            ...
                                            <input type="text" placeholder="Payment Date"
                                                class="form-control datepicker" name="paydate" required
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Transecton or Mobile no"
                                                class="form-control" name="transno" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
