        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i>Update Student Seat
                    Alocation[<?php echo $GLOBALS['userId'];?>]
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="seat" action="seatalaction.php?update=1" accept-charset="utf-8" method="post"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="blockNo" required="">
                                            ...
                                            <option value="<?php echo $data[0];?>" selected><?php echo $data[0];?>
                                            </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="roomNo" required="">
                                            ...
                                            <option value="<?php echo $data[1];?>" selected><?php echo $data[1];?>
                                            </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Monthly Rent" class="form-control"
                                                name="mrent" value="<?php echo $data[2];?>" required>
                                        </div>
                                    </div>
                                </div>
