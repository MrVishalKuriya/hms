        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="fees" action="blockaction.php?update=1" accept-charset="utf-8" method="post"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Block No" class="form-control"
                                                        name="blockNo" value="<?php echo $blockNo;?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Block Name" class="form-control"
                                                        name="blockName" value="<?php echo $blockName;?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
