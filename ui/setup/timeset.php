...
if ($ses->isExpired()) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $msg = $db->open();
        if ($msg === "true") {  // Fixed comparison operator
            $data = array();
            $result = $db->getData("SELECT * FROM timeset");

            if ($result && $result instanceof mysqli_result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    array_push($data, htmlspecialchars($row['inTime'] ?? ''));
                    array_push($data, htmlspecialchars($row['outTime'] ?? ''));
                }
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i> Hostel Time Set <span id="lblmsg"> (Click On Clock
                        Icon)</span>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="mealrate" action="timeset.php" accept-charset="utf-8" method="post"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" id="timepicker2" name="start_time"
                                                        data-default-time="false" placeholder="h:mm AM"
                                                        class="form-control"
                                                        value="<?php echo $GLOBALS['start_time']; ?>" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" id="timepicker1" name="end_time"
                                                        data-default-time="false" placeholder="h:mm AM"
                                                        class="form-control" value="<?php echo $GLOBALS['end_time']; ?>"
                                                        required>
                                                    <span class="input-group-addon"><i
                                                            class="glyphicon glyphicon-time"></i></span>
                                                </div>
