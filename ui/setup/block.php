    ...
    if ($msg = "true") {
        ...
        if ($result && $result instanceof mysqli_result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $GLOBALS['output'] .= "<td>" . htmlspecialchars($row['blockNo'] ?? '') . "</td>";
                $GLOBALS['output'] .= "<td>" . htmlspecialchars($row['blockName'] ?? '') . "</td>";
                $GLOBALS['output'] .= "<td>" . htmlspecialchars($row['description'] ?? '') . "</td>";
                $GLOBALS['output'] .= "<td>" .
                    "<a title='Edit' class='btn btn-success btn-circle' href='blockaction.php?id=" . htmlspecialchars($row['blockId'] ?? '') . "&amp;wtd=edit'>" .
                    "<i class='fa fa-pencil'></i></a>&nbsp;&nbsp;" .
                    "<a title='Delete' class='btn btn-danger btn-circle' href='blockaction.php?id=" . htmlspecialchars($row['blockId'] ?? '') . "&amp;wtd=delete'>" .
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="fees" action="block.php" accept-charset="utf-8" method="post"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Block Name" class="form-control"
