        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="fees" action="feesaction.php?update=1" accept-charset="utf-8" method="post"
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Fee Tye" class="form-control"
                                                        name="type" value="<?php echo $type;?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Amount"
                                                        value="<?php echo $amount;?>" class="form-control" name="amount"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
