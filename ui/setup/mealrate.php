        ...
        if ($msg = "true") {
            ...
            if ($result && $result instanceof mysqli_result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    array_push($data, htmlspecialchars($row['rate'] ?? ''));
                    array_push($data, htmlspecialchars($row['note'] ?? ''));
                }
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="mealrate" action="mealrate.php" accept-charset="utf-8" method="post"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Meal Rate" class="form-control"
                                                        value="<?php echo $GLOBALS['rate']; ?>" name="rate" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea rows="1" placeholder="Note" class="form-control"
                                                        name="note" required><?php echo $GLOBALS['note']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
