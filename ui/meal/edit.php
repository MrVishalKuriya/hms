        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="deposit" action="edit.php?update=1" accept-charset="utf-8" method="post"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="No Of meal" class="form-control"
                                                        name="noOfMeal" value="<?php echo $data[1]; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group date" id='dp1'>
                                                    ...
                                                    <input type="text" placeholder="Date"
                                                        ...
                                                        value="<?php echo $data[2]; ?>" required
