        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="attendence" action="list.php?update=1" accept-charset="utf-8" method="post"
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" placeholder="" class="form-control" name="person"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group date" id='dp1'>
                                            ...
                                            <input id="attendDate" type="text" placeholder="Attend Date" disabled
                                                class="form-control datepicker" name="attendDate" required
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="remark" type="text" placeholder="Additional Info"
                                                class="form-control" name="remark" required>
                                        </div>
                                    </div>
                                </div>
