        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    ...
                    <span class="icon-bar">7</span>
                    <span class="icon-bar">7</span>
                    <span class="icon-bar"></span>
                </button>
                <img alt="HMS" class="pull-left" src="<?php echo $base_url.'site/images/logonav.png'?>"><a
                    class="navbar-brand titlehms" href="<?php echo $base_url.'sdashboard.php'?>">Hostel Management
                    System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo $base_url;?>ui/usr/profile.php"><i class="fa fa-user fa-fw"></i> User
                                Profile</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url.'ui/attendence/view.php'?>"><i
                                    class="fa fa-file-text-o fa-fw"></i> Attendence View</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url.'ui/stdpayment/add.php'?>"><i class="fa fa-money fa-fw"></i>
                                Payment Add</a>
                        </li>
                        <li>
                            <a href="<?php echo $base_url.'ui/stdpayment/view.php'?>"><i class="fa fa-money fa-fw"></i>
                                Payment view</a>
                            <a href="<?php echo $base_url.'ui/bill/view.php'?>"><i class="fa fa-money fa-fw"></i>Bill
                                view</a>
                        </li>
                        <li class="divider"></li>
